...
En el PDF Se encuentra explicado
...
campo únicamente para la siguiente entrada o salida. Por defecto es 0, pero esta funcion expande cuanto sea necesario y tambien se agrego 
int tamanioArreglo = 4; y se declaro al inicio del codigo las funciones.
*/
...
int main(){
   ...
   //int a[tamanioArreglo] = {5, 72 , 6 , 17};//Declara el vector a con los valores a[0] = 54; a[1] = 2; a[2] = 46; a[3] = 7;
